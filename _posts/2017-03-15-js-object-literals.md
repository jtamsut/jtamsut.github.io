---
layout: post
title: "Objects in JavaScript: A Pragmatic Approach"
...
A JavaScript object is a collection of key-value pairs. The keys are called **keys** and the values are called **values**. Key-value pairs are separated by commas (`,`) and are called **properties**. Keys and values are delineated with a colon (`:`).
...
This was an introduction to the fundamental ideas pertaining to JS object literals. For more information about objects and JS in general take a look at [javascript.info](http://javascript.info/).